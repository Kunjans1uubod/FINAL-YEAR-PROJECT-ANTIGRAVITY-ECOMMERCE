    ...
    <div className="page-transition-enter-active">
      <div className="category-header">
        <div className="container" style={{ textAlign: 'center' }}>
          <h1 style={{ fontFamily: 'var(--font-serif)', marginBottom: '1rem' }}>Men's Collection</h1>
          <p style={{ color: 'var(--secondary)', maxWidth: '600px', margin: '0 auto' }}>
            Elevate your everyday aesthetic with our curated selection for men. Minimalist lines, premium fabrics, and timeless design.
          </p>
        </div>
      </div>
